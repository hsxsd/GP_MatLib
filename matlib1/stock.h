...
extern "C" __declspec(dllexport) int gethistory(double *out, int mark,char *code,int start, int count,int zq);//读取历史数据,mark=市场(0=深圳，1=上海） code=代码 count=数量（从后往前计算，最大 800） zq=周期
